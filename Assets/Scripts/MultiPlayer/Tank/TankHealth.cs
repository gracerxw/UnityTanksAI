...
namespace CE6127.Tanks.MultiPlayer
{
    ...
    public class TankHealth : MonoBehaviour
    {
        ...
        private bool m_Destroyed;                       // Has the tank been reduced beyond zero health yet?

        /// <summary>
        /// Method <c>Awake</c> instantiate the explosion prefab and get a reference to the particle system on it.
        /// </summary>
        private void Awake()
        {
        ...
        public void TakeDamage(float amount)
        {
            ...
            if (m_CurrentHealth <= 0f && !m_Destroyed)
                OnDeath();
        }
        ...
        /// <summary>
        /// Method <c>OnDeath</c> play the effects for the death of the tank and deactivate it.
        /// </summary>
